...
Canonical set of CSS custom properties used by the `styles` skill. All generated theme files must define every required role. Optional roles may be omitted.
