...
Extended from acss-app-builder/scripts/validate_theme.py:
  - Same file targeting (light.css, dark.css, brand-*.css)
  - Same exit codes and output contract
  - Expanded from 3 pairs to 10 pairs (full role catalogue coverage)
